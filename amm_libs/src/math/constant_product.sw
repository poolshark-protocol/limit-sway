...
impl ConstantProduct {
    ...
    pub fn check_ticks(
        ...
        require(lower.ge(Self::min_tick(tick_spacing_i24)), "INPUT ERROR: lower tick below minimum.");
        require(upper.lt(Self::max_tick(tick_spacing_i24)), "INPUT ERROR: upper tick above maximum.");
